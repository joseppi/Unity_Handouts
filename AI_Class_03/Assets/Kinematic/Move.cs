...
public class Move : MonoBehaviour {
	...
	void Update () 
	{
        ...
        rad *= Mathf.Rad2Deg;
        aim.transform.rotation = Quaternion.AngleAxis(rad, Vector3.up);
        ...
        arrow.value = mov_velocity.magnitude * 5;

        // TODO 4: update tank position based on final mov_velocity and deltatime
		mov_velocity = mov_velocity * Time.deltaTime;
		transform.position += mov_velocity;
